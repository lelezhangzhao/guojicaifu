<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"E:\share\project\trunk\tp5\public/../application/gjcf\view\chargeconfirm\index.html";i:1532077036;s:60:"E:\share\project\trunk\tp5\application\gjcf\view\layout.html";i:1531971031;s:60:"E:\share\project\trunk\tp5\application\gjcf\view\header.html";i:1532420663;s:60:"E:\share\project\trunk\tp5\application\gjcf\view\footer.html";i:1532420336;}*/ ?>
<html>
<head>
    <title>确认充值</title>
    <meta charset="utf-8">
    ...
    <ul class="layui-nav" >
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                <dd id="project"><a href="">项目列表</a></dd>
                <dd id="investrecord"><a href="">投资记录</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item">
            <a href="javascript:;">充值提现</a>
            <dl class="layui-nav-child">
                <dd id="charge"><a href="">充值</a></dd>
                <dd id="withdraw"><a href="">提现</a></dd>
                <dd id="ydcrecord"><a href="">收益记录</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item">
            <a href="javascript:;">账户管理</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
                <dd id="fixaccountinfo"><a href="">支付账户</a></dd>
                <dd id="fixpassword"><a href="">修改密码</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item">
            <a href="javascript:;">团队信息</a>
            <dl class="layui-nav-child">
                <dd id="myteam"><a href="">我的团队</a></dd>
            </dl>
        </li>
